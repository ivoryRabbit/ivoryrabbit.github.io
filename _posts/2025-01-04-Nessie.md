...
image:
    ...
    alt:      출처 - [Project Nessie 공식 문서](https://projectnessie.org){: target="_blank"}
...
![image_01](/assets/img/posts/2025-01-04/image_01.png){: width="800" }*참조 - https://iceberg.apache.org/spec/#overview*
...
SELECT COUNT(1) FROM nessie.people;
```
...
SELECT COUNT(1) FROM nessie.people;nessie
```
...
![image_10](/assets/img/posts/2025-01-04/image_10.png){: width="800" }